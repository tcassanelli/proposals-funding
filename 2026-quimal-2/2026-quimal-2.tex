...
\begin{figure}[t]
  ...
  \caption{Very first optical pulses fully resolved by IQUEYE at Gemini South \cite{2025SPIE13624E..1RC}. Similar results will be expanded to other sources and case studies. Notice that this is a single pulse phase and it has not been folded over time. This is the unprecedented time resolution and improved signal-to-noise ratio that our team can achieve.}
\end{figure}
...
\begin{figure}[t]
  ...
  \begin{ganttchart}[
    ...
    \ganttlink[link/.append style={blue!70!black}]{o1a}{o1b}
    \ganttlink[link/.append style={blue!70!black}]{o1b}{o2b}
    \ganttlink[link/.append style={teal!70!black}]{o2a}{o2b}
    \ganttlink[link/.append style={teal!70!black}]{o2a}{o2c}
    \ganttlink[link/.append style={blue!70!black}]{o1b}{o3b}
    \ganttlink[link/.append style={orange!70!black}]{o3a1}{o3b}
  \end{ganttchart}
\end{figure}
