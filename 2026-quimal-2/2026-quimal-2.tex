...
% pandoc -t plain --bibliography=refs.bib --citeproc --csl ieee.csl --wrap=none 2026-quimal-2.tex 2026-quimal-2.txt 
...
\begin{figure}[t]
  ...
  \caption{Very first optical pulses from the Crab pulsar (PSR J0534$+$2200) fully resolved and observed with IQUEYE at Gemini South \cite{2025SPIE13624E..1RC}. Similar results will be expanded to other sources and case studies. Notice that this is a single pulse phase and it has not been folded over time. This is the unprecedented time resolution and improved signal-to-noise ratio that our team can achieve.}
  \label{fig:crab}
\end{figure}
...
Note that the 2027A observing proposal (O3a) will be submitted in September 2026, prior to the project start; this pre-project submission is not shown in the work plan below, which covers the funded period only. The first in-project proposal cycle (Q1) targets semester 2027B.

\textbf{Q1---instrument preparation.} The project will begin by establishing the instrumental capability described in O1a. Our team will install IQUEYE at an available instrument support structure (ISS) port, reposition its GPS antenna, repair its auxiliary SPAD sky camera, and install a service and control computer in the Gemini South control room. This computer will enable remote monitoring and operation during observations. In parallel, we will prepare the initial observing, calibration, and data-reduction procedures (O2a), submit the first cycle of science proposals (O3a), and begin coordinating complementary radio and X-ray observations (O3c). Potential partners include the Instituto Argentino de Radioastronomía 30-m telescope, the Algonquin Radio Observatory 46-m telescope, and collaborators working with NICER.
...
\begin{figure}[t]
  ...
  \begin{ganttchart}[
    ...
    % O1: blue
    \ganttset{group/.append style={fill=blue!30}, bar/.append style={fill=blue!60}}
    \ganttgroup[name=g1]{O1: Establish the capability}{1}{4} \\
    \ganttbar[name=o1a]{(a) Instrument preparation and installation}{1}{2} \\
    \ganttbar[name=o1b]{(b) Recommissioning and validation}{3}{4} \\

    % O2: teal
    \ganttset{group/.append style={fill=teal!30}, bar/.append style={fill=teal!60}}
    \ganttgroup[name=g2]{O2: Enable sustained access}{1}{16} \\
    \ganttbar[name=o2a]{(a) Operational and reduction procedures}{1}{4} \\
    \ganttbar[name=o2b]{(b) Gemini South and community support}{5}{16} \\
    \ganttbar[name=o2c]{(a) Procedure review and refinement}{5}{16} \\
    \ganttmilestone[name=o2d]{(b) Return IQUEYE to Asiago}{16} \\

    % O3: orange
    \ganttset{group/.append style={fill=orange!30}, bar/.append style={fill=orange!60}}
    \ganttgroup[name=g3]{O3: Deliver scientific results}{1}{16} \\
    \ganttbar[name=o3a1]{(a) Proposal preparation and submission}{1}{2}
    \ganttbar[name=o3a2]{}{5}{6}
    \ganttbar[name=o3a3]{}{9}{10} \\
    % Observing campaigns segmented by semester (mid-quarter start, end of quarter end)
    \ganttbar[name=o3b27a]{}{2}{4}
    \ganttbar[name=o3b27b]{2027A, 2027B, 2028A, and 2028B}{6}{8}
    \ganttbar[name=o3b28a]{}{10}{12}
    \ganttbar[name=o3b28b]{}{14}{16} \\
    \ganttbar[name=o3c1]{(b) Data reduction and scientific analysis}{2}{5}
    \ganttbar[name=o3c2]{}{6}{9}
    \ganttbar[name=o3c3]{}{10}{13}
    \ganttbar[name=o3c4]{}{14}{16} \\
    \ganttmilestone[name=o3pub1]{(b) Scientific publications}{8}
    \ganttmilestone[name=o3pub2]{}{16} \\
    \ganttbar[name=o3d]{(c) Multiwavelength coordination}{1}{16}
